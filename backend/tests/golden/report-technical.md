...
- Base URL: `https://assistant.example.test`
- Adapters: chat_http
- Endpoints in scope: 2
...
No findings in this category. See Framework coverage for whether ai findings were tested at all.

## API findings

No findings in this category. See Framework coverage for whether api findings were tested at all.

## AppSec findings

No findings in this category. See Framework coverage for whether appsec findings were tested at all.
...
Comparison is by fingerprint, which is stable across runs. A full before/after evidence comparison arrives with the retest workflow.
